    ...
    <div className="p-6">
      ...
      {isLoading ? (
        ...
        <>
            ...
            {[
              {
                icon: MessageSquare,
                label: "Conversations",
                value: data.totalConversationsThisPeriod.toLocaleString(),
              },
              {
                icon: Clock,
                label: "Avg Response",
              ...
              <div className="space-y-3">
                ...
                {data.topUsers.map((user, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-zinc-400">
                      {user.total_messages.toLocaleString()} msgs
                    </span>
                  </div>
                ))}
              </div>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-6">
            <h3 className="mb-4 text-sm font-medium text-zinc-300">
              Response Time Distribution (Last 7 Days)
            </h3>
            <p className="text-3xl font-bold text-white">
              {data.avgResponseTime}ms{" "}
              <span className="text-sm font-normal text-zinc-500">average</span>
            </p>
          </div>
        </>
      )}
