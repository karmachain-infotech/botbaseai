...
import {
  ...
  updateAction,
  deleteAction,
} from "@/lib/server-functions/actions";
      ...
      <div className="mt-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Let your agent perform actions via API calls.
          </p>
        </div>
        <button
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                value={form.method}
                onChange={(e) =>
                  setForm({ ...form, method: e.target.value as AiactionMethod })
                }
                className="w-full rounded-lg border border-border bg-background px-3 py-2.5 text-sm outline-none focus:border-primary"
              >
      ...
      <div className="mt-6 space-y-3">
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-border p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Create AI actions to let your agent interact with external APIs.
            </p>
          </div>
        ) : (
          actions.map((action) => (
              ...
              <div className="flex items-center gap-2 shrink-0 ml-4">
                ...
                >
                  <AlertDialogTrigger asChild>
                    <button
                      onClick={() => setDeleteTarget(action.id)}
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        <strong>{action.name}</strong>. Your agent will no
                        longer be able to use this action. This cannot be
                        undone.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
