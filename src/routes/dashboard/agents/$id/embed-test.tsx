...
function EmbedTest() {
  ...
  const resolvedBase = (baseUrl.trim() || defaultBase).replace(/\/+$/, "");
          ...
          <div className="overflow-hidden rounded-2xl border border-border bg-card">
            <div className="flex items-center justify-between border-b border-border px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 rounded bg-secondary px-2 py-0.5 text-xs text-muted-foreground font-mono">
                  yourwebsite.com
                </span>
              </div>
              <a
                href={`/api/widget/${id}/config`}
                target="_blank"
                rel="noreferrer"
              ...
              <div className="flex h-full flex-col items-center justify-center p-8 text-center">
                <div className="rounded-xl bg-white p-8 shadow-sm border border-border max-w-md">
                  ...
                  <p className="mt-3 text-gray-600 leading-relaxed">
                    This is a live preview of how your chatbot widget will
                    appear on your website. Click the chat bubble in the
                    bottom-right corner to test your bot.
                  </p>
                  <div className="mt-6 grid gap-3 text-left">
                    {[
                      {
                        label: "Product A",
                        desc: "Learn about our flagship product",
                      },
                      {
                        label: "Product B",
                        desc: "Explore our premium offering",
                      },
                      {
                        label: "Pricing",
                        desc: "View our flexible pricing plans",
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
                  ...
                  <div className="mt-6 rounded-lg bg-gray-50 border border-border p-4 text-sm text-gray-600">
                    ...
                    <p>
                      Click the chat bubble below to ask your AI agent a
                      question.
                    </p>
                  </div>
                </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <div className="mt-3 space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span
                  className={`font-medium ${agent?.status === "live" ? "text-primary" : "text-muted-foreground"}`}
                >
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-right text-xs max-w-[180px] truncate">
                  {greeting}
                </span>
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <div className="mt-3">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Leave empty to use the default BotbaseAI domain.
              </p>
            </div>
          ...
          {agent?.status !== "live" && (
            <div className="rounded-2xl border border-dashed border-amber-300 bg-amber-50 p-4 text-sm">
              ...
              <p className="mt-1 text-amber-700">
                Set the agent status to <strong>Live</strong> in Settings for
                the widget to appear on your actual website.
              </p>
              <Link
                to="/dashboard/agents/$id/settings"
                params={{ id }}
