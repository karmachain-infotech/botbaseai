  ...
  head: () => ({
    meta: [
      { title: "Customers — BotbaseAI" },
      {
        name: "description",
        content:
          "See how thousands of businesses use BotbaseAI to transform their customer support.",
      },
    ],
  }),
  component: Customers,
...
const featuredStory = {
  ...
  logo: "O",
  quote:
    "BotbaseAI lets our team resolve support at a scale we never thought possible. The AI agents handle the majority of inquiries autonomously, freeing our human team to focus on complex issues that require deep expertise.",
  name: "Sarah Chen",
...
const caseStudies = [
  {
    ...
    logo: "S",
    quote:
      "We deployed our agent in a day and cut response times dramatically. Our customers get instant answers to common questions, and our team can focus on high-value conversations.",
    name: "Marcus Webb",
  ...
  },
  {
    ...
    logo: "C",
    quote:
      "Our customers love the instant, accurate answers from BotbaseAI. We've seen a significant boost in satisfaction scores since deploying the agent across our support channels.",
    name: "Jessica Torres",
  ...
  },
  {
    ...
    logo: "S",
    quote:
      "An essential part of our customer support stack. The multilingual capabilities let us serve our global member base without hiring additional support staff.",
    name: "Alex Rivera",
    role: "Support Lead",
  ...
  },
  {
    ...
    logo: "P",
    quote:
      "The API-first approach of BotbaseAI integrates seamlessly with our existing toolchain. We automated developer onboarding and reduced ticket volume by half.",
    name: "Dylan Kim",
  ...
  },
  {
    ...
    logo: "S",
    quote:
      "Enterprise-grade security was our top concern. BotbaseAI's SOC 2 compliance and data encryption gave us the confidence to deploy across our global support operation.",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pt-24 pb-16 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            From startups to enterprises, teams everywhere use BotbaseAI to
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap gap-2 border-t border-border/60 pt-4">
                {cs.results.map((r) => (
                  <span
                    key={r}
                    className="rounded-md border border-border bg-secondary px-2 py-1 text-xs font-medium text-primary"
                  >
                    {r}
                  </span>
                ))}
