  ...
  head: () => ({
    meta: [
      { title: "Sign up — BotbaseAI" },
      {
        name: "description",
        content:
          "Create your free BotbaseAI account and build an AI agent in minutes.",
      },
    ],
  }),
  component: Signup,
...
function Signup() {
  ...
  async function handleGoogleSignup() {
    setError("");
    track("signup_initiated", { method: "google" });
          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium transition-colors hover:bg-secondary"
              >
