...
import { ArrowRight, Brain, Zap, MessageSquare, BarChart3, Globe, Plug, ShieldCheck, GitCompare, PhoneForwarded, RefreshCw } from "lucide-react";
...
export const Route = createFileRoute("/solutions")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "See how BotbaseAI's AI agents transform customer support across every channel." },
    ],
  }),
  component: Solutions,
});
...
const useCases = [
  {
    ...
    features: ["24/7 instant responses", "Multi-channel support", "Smart ticket routing", "Sentiment analysis"],
  },
  {
    icon: Zap,
    ...
    features: ["Lead scoring & routing", "Product recommendations", "Calendar booking", "Follow-up automation"],
  },
  {
    icon: Brain,
    ...
    features: ["Auto-sync with sources", "Semantic search", "Citation-backed answers", "Auto-refresh on content change"],
  },
  {
    icon: Globe,
    title: "Multilingual Support",
    desc: "Serve customers in 80+ languages with the same AI agent — no translation middleware or separate bots needed.",
    features: ["Real-time translation", "Language auto-detection", "Consistent tone across languages", "Regional compliance"],
  },
  {
    icon: BarChart3,
    title: "Analytics & Insights",
    desc: "Understand what customers are asking about, track resolution rates, and identify gaps in your knowledge base.",
    features: ["Conversation analytics", "Trend detection", "CSAT tracking", "Knowledge gap reports"],
  },
  {
    icon: PhoneForwarded,
    ...
    features: ["Smart escalation rules", "Context-rich handoff", "Co-browsing mode", "Agent inbox integration"],
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pt-24 pb-16 text-center sm:px-6 lg:px-8">
          <h1 className="text-balance text-4xl font-extrabold tracking-tight sm:text-6xl">
            Solutions for every <span className="text-gradient">support challenge</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            From automated ticketing to multilingual support, BotbaseAI transforms how your team serves customers.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {useCases.map((u) => (
            <div key={u.title} className="rounded-2xl border border-border bg-card p-6 transition-colors hover:border-primary/50">
      ...
      <section className="border-y border-border/60 bg-card/40">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-wider text-primary">Channels</p>
            <h2 className="mx-auto mt-3 max-w-2xl text-balance text-3xl font-bold tracking-tight sm:text-4xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {channels.map((c) => (
              <div key={c.name} className="flex items-center gap-4 rounded-xl border border-border bg-card p-5">
